...
Curvature radius and offset values are [converted](https://github.com/AM5800/self_driving_car/blob/master/advanced_lanes_detection/pipeline.py#L104) to meters with corresponding coefficients from the lecture.
